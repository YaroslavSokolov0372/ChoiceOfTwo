...
//        changeMailButton.translatesAutoresizingMaskIntoConstraints = false
        ...
        NSLayoutConstraint.activate([
            ...
            circleImage.topAnchor.constraint(equalTo: backButton.bottomAnchor, constant: 30),
...
//            changeMailButton.widthAnchor.constraint(equalTo: view.widthAnchor, multiplier: 0.90),
            ...
            logoutButton.topAnchor.constraint(equalTo: self.circleImage.bottomAnchor, constant: 40),
