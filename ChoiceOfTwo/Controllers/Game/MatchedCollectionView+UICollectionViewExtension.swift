//
//  MatchedCollectionView+UICollectionViewExtension.swift
//  ChoiceOfTwo
//
...
extension MatchedController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.vm.matched.count
    }
